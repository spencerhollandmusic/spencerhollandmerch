...
const tpl = { brand:{name,logo:"/logos/acme.svg"}, theme:{primary,accent,muted:"#f3f4f6"},
  ...
  hero:{headline:`${name}: We do awesome things.`, sub:"Replace this with your elevator pitch.", ctaLabel:"Get started",
        highlights:[{title:"Quality",desc:"Top-notch work."},{title:"Speed",desc:"Fast turnaround."},{title:"Support",desc:"We’re here to help."},{title:"Value",desc:"Fair pricing."}]},
  ...
  cta:{title:"Ready to begin?",desc:"We’d love to work with you.",ctaLabel:"Contact us"},
